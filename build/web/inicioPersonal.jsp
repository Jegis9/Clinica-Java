<%-- 
    ...
    Created on : 11 abr. 2023, 11:58:04
    Author     : AsusVivoBook
--%>
...
<head>
    <meta charset="utf-8">
    <title>Inicio sesion - Consultorio Totonicapan</title>
    ...
    <table style="margin: 0 auto">
        ...
        <tr>
            <td><div class="card" style="width: 18rem;">
                    <img src="img/Iconos/login.png" class="card-img-top" alt="..." height="190">
                <div class="card-body">
                    <button type="button" class="btn btn-primary" ><a href="index.jsp" style="color: aliceblue;">Iniciar sesion</a> </button>
                </div>
              </div>
            </td>
