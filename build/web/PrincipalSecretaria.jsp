        ...
        <table style="margin: 0 auto">
            ...
            <tr>
                <td><div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-primary" ><a href="listarCitasSecretaria.jsp" style="color: aliceblue;">Citas</a> </button>
                    </div>
                  </div>
                </td>
            ...
            <td>
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-primary"><a href="agregarCitaSecretaria.jsp" style="color: aliceblue;">Agendar</a> </button>
