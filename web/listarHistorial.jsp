...
<body>
    ...
    ResultSet rs;
        ...
        ps = con.prepareStatement("SELECT historialMedico.id_historial,historialMedico.id_paciente,paciente.nombre,empleados.nombre,historialMedico.fecha_hora,historialMedico.descripcion_consulta " +
                                      "FROM historialMedico " +
                                      "INNER JOIN paciente " +
                                      "ON historialMedico.id_paciente=paciente.id_paciente "+
                                      "INNER JOIN empleados " +
                                      "ON historialMedico.id_empleado= empleados.id_empleado;"  );
...
<div margin="10px">
     <h1 style="text-align: center">HISTORIALES</h1>
    <table  class="table table-striped table-hover">
        ...
        <tr>
            ...
            <td><%= rs.getString("descripcion_consulta")%></td>
            <td>
                
                <a class="btn btn-outline-secondary">EDITAR</a>
                <a class="btn btn-outline-danger">ELIMINAR</a>
                <a class="btn btn-outline-danger" href="facturacion.jsp">FACTURACION</a>
            </td>
        <tr>
           <%}%>
    </table>
