...
ResultSet rs;
String nombre,apellido,f_nacimiento,direaccion,telefono,correo,cargo;
...
if (nombre!=null && apellido!=null &&  f_nacimiento!=null &&direaccion!=null &&telefono!=null && correo!=null && cargo!=null) {
        ps= con.prepareStatement("insert into empleados (nombre,apellido,f_nacimiento,direaccion,telefono,correo,cargo) values('"+nombre+"','"+apellido+"','"+f_nacimiento+"','"+direaccion+"','"+telefono+"','"+correo+"','"+cargo+"')");
        ps.executeUpdate();
        response.sendRedirect("agregarUsuariosEmpleados.jsp");
    }
