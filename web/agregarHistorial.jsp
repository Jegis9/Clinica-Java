...
<div class="container-fluid">
    <div class="container">
        <center>
        <h1>AGREGAR NUEVO HISTORIAL PACIENTE</h1>
        <form method="post" action="" class="form-control" style="width: 500px; height: 400px">
           ...
           <label>DOCTOR ID</label>
            <input type="text" name="txtdoctor" class="form-control">
...
String id_paciente,id_empleado,descripcion_consulta;
id_paciente=request.getParameter("txtpaciente");
id_empleado=request.getParameter("txtdoctor");
descripcion_consulta=request.getParameter("txtdescripcion");

if (id_paciente!=null && id_empleado!=null &&  descripcion_consulta!=null) {
        ps= con.prepareStatement("insert into historialMedico (id_paciente,id_empleado,descripcion_consulta,fecha_hora) values('"+id_paciente+"','"+id_empleado+"','"+descripcion_consulta+"','"+fechaSQL+"')");
        ps.executeUpdate();
