...
ResultSet rs;
String usuario,id_empelado,contraseña,rol;
usuario=request.getParameter("txtusuario");
id_empelado=request.getParameter("txtempleado");
contraseña=request.getParameter("txtcontraseña");
rol=request.getParameter("txtrol");

if (usuario!=null && contraseña!=null &&  rol!=null ) {
        ps= con.prepareStatement("insert into usuarios (usuario,id_paciente,contraseña,rol) values('"+usuario+"','"+id_empelado+"','"+contraseña+"','"+rol+"')");
        ps.executeUpdate();
